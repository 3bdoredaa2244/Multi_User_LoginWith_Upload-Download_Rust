...
function _abytes2(value3, length, title = "") {
  ...
  const len = value3 == null ? void 0 : value3.length;
...
function eddsa(Point, cHash, eddsaOpts = {}) {
  ...
  const utils = {
    ...
    toMontgomery(publicKey) {
      ...
      const u = is25519 ? Fp4.div(_1n8 + y, _1n8 - y) : Fp4.div(y - _1n8, y + _1n8);
...
function _eddsa_legacy_opts_to_new(c) {
  ...
  const curveOpts = { Fp: Fp4, Fn: Fn2, uvRatio: c.uvRatio };
  const eddsaOpts = {
...
var _RistrettoPoint = class __RistrettoPoint extends PrimeEdwardsPoint {
  ...
  static fromBytes(bytes) {
    ...
    return new __RistrettoPoint(new ed25519.Point(x, y, _1n10, t));
  }
  /**
...
`);
  ...
  async syncTime(canisterId) {
    await __classPrivateFieldGet4(this, _HttpAgent_instances, "m", _HttpAgent_rootKeyGuard).call(this);
    const CanisterStatus = await import("./canisterStatus-KOQUKW5T.js");
...
@noble/curves/esm/ed25519.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-2WFGDWMV.js.map
